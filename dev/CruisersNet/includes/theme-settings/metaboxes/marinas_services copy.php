...
function marinaservices_metabox_save( $post_id ) {
	...
	if( isset( $_POST['mcf-boatus-discount'] ) )
	...
	if( isset( $_POST['mcf-marinalife-discount'] ) )
	...
	if( isset( $_POST['mcf-seatow-discount'] ) )
