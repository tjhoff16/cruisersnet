...
if (post_password_required() || !comments_open()):
    ...
    <?php if (have_comments()) : ?>  
        <div id="comments">
            <h3>
                <?php comments_number(__('Be the first to review on this Marina!', 'cnet'), __('Reviews from the Cruisers\' Net Community (1)', 'cnet'), __('Reviews from the Cruisers\' Net Community (%)', 'cnet')); ?>                
            </h3>
