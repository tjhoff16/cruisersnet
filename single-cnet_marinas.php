                    ...
                    <div <?php post_class('clearfix'); ?>>  
							...
							<header class="entry-header">
                            	...
                            	<div class="sponsored-listing-wrap">
                            		...
                            		<a class="ttip gofollow" data-track="<?php
                                            $adID = get_post_meta($post->ID,'marina_sponsor_ad_id', true);
                                            if ( function_exists(adrotate_hash) ) echo  adrotate_hash($adID, 0, 0);
                                        ?>" data-toggle="tooltip" title="Click Here to Visit this Sponsors Website" href="<?php echo get_post_meta($post->ID,'marina_url',true); ?>" target="_blank" class="marina-visit">
