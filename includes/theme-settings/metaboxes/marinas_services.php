...
function marinaservices_metabox_cb($post) {
	...
	$mcable = isset( $values['mcf-cable'] ) ? esc_attr( $values['mcf-cable'][0] ) : '';
	$mcable_notes = isset( $values['mcf-cable-notes'] ) ? esc_attr( $values['mcf-cable-notes'][0] ) : '';
	
	
	$mwifi = isset( $values['mcf-wifi'] ) ? esc_attr( $values['mcf-wifi'][0] ) : '';
	$monspotwifi = isset( $values['mcf-OnSpotWiFi'] ) ? esc_attr( $values['mcf-OnSpotWiFi'][0] ) : '';
	...
	$mssecn = isset( $values['mcf-ssecn-discount'] ) ? esc_attr( $values['mcf-ssecn-discount'][0] ) : '';
	...
	$mother = isset( $values['mcf-other-discount'] ) ? esc_attr( $values['mcf-other-discount'][0] ) : '';
    
    $mssecn_notes = isset( $values['mcf-ssecn-discount-notes'] ) ? esc_attr( $values['mcf-ssecn-discount-notes'][0] ) : '';
    ...
    $mother_notes = isset( $values['mcf-other-discount-notes'] ) ? esc_attr( $values['mcf-other-discount-notes'][0] ) : '';
	...
	<table class="cnet_metabox_table" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td class="notes">
				...
				<tr>
    <td class="label2">CruisersNet Dockage Discount:</td>
    <td class="mcheckbox"><input type="checkbox" name="mcf-ssecn-discount" value="yes" ' . checked($mssecn, 'yes',false) . ' /></td>
    <td class="notes">
				<table class="notes-table" cellpadding="0" cellspacing="0">
    <tr>
    <td class="nlabel">Notes:</td>
    <td><input type="text" name="mcf-ssecn-discount-notes" id="discount" value="' . $mssecn_notes . '" /></td>
    </tr>
				</table>
    </td>
    </tr>
    ...
    <tr>
    <td class="label2">Other Dockage Discount:</td>
    <td class="mcheckbox"><input type="checkbox" name="mcf-other-discount" value="yes" ' . checked($mother, 'yes',false) . ' /></td>
    <td class="notes">
				<table class="notes-table" cellpadding="0" cellspacing="0">
    <tr>
    <td class="nlabel">Notes:</td>
    <td><input type="text" name="mcf-other-discount-notes" id="mcf-other-discount-notes" value="' . $mother_notes . '" /></td>
    </tr>
				</table>
    </td>
    </tr>
		...
		<tr>
			<td class="label2">Cable TV:</td>
			<td class="mcheckbox"><input type="checkbox" name="mcf-cable" value="yes" ' . checked($mcable, 'yes',false) . ' /></td>
			<td class="notes">
				<table class="notes-table" cellpadding="0" cellspacing="0">
					<tr>
						<td class="nlabel">Notes:</td>
						<td><input type="text" name="mcf-cable-notes" id="mcf-cable-notes" value="' . $mcable_notes . '" /></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="notes">
				<table class="notes-table" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="nlabel"><input type="checkbox" style="width:10px;" name="mcf-OnSpotWiFi" value="yes" ' . checked($monspotwifi, 'yes',false) . ' /></td>
                        <td><img src="/images/SiteGraphics/OnSpotWiFi_150x27px.jpg" alt="OnSpotWiFi:"/></td>
                    </tr>
				</table>
			</td>
		</tr>
...
function marinaservices_metabox_save( $post_id ) {
	...
	update_post_meta( $post_id, 'mcf-ssecn-discount', wp_kses( $_POST['mcf-ssecn-discount'], $allowed ) );
    ...
    update_post_meta( $post_id, 'mcf-other-discount', wp_kses( $_POST['mcf-other-discount'], $allowed ) );
	update_post_meta( $post_id, 'mcf-OnSpotWiFi', wp_kses( $_POST['mcf-OnSpotWiFi'], $allowed ) );
    ...
    if( isset( $_POST['mcf-ssecn-discount-notes'] ) )
        update_post_meta( $post_id, 'mcf-ssecn-discount-notes', wp_kses( $_POST['mcf-ssecn-discount-notes'], $allowed ) );
    ...
    if( isset( $_POST['mcf-other-discount-notes'] ) )
        update_post_meta( $post_id, 'mcf-other-discount-notes', wp_kses( $_POST['mcf-other-discount-notes'], $allowed ) );
	if( isset( $_POST['mcf-cable'] ) )
		update_post_meta( $post_id, 'mcf-cable', wp_kses( $_POST['mcf-cable'], $allowed ) );
	if( isset( $_POST['mcf-cable-notes'] ) )
		update_post_meta( $post_id, 'mcf-cable-notes', wp_kses( $_POST['mcf-cable-notes'], $allowed ) );
}
