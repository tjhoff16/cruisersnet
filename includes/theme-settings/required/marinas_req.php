...
/* =========================================================
MARINA SETTINGS TAXONOMY (Right now really only used for "Not A Marina")
============================================================ */
register_taxonomy('cnet_marina_settings', array('cnet_marinas','post'), array('label'=>'Marina Settings', 'public'=>true,'show_in_nav_menus'=>true, 'show_ui'=>true, 'show_tagcloud'=>false, 'hierarchical'=>true, 'rewrite' => array( 'slug' => 'marina-settings' ), 'labels'=>array(
	'name' => 'Settings',
	'singular_name' => 'Settings',
	'search_items' => 'Search Settings',
	'popular_items' => 'Popular Settings',
	'all_items' => 'All Settings',
	'parent_item' => 'Parent Setting',
	'parent_item_colon' => 'Parent Setting:',
	'edit_item' => 'Edit Setting',
	'update_item' => 'Edit Setting',
	'add_new_item' => 'Add New Setting',
	'new_item_name' => 'New Setting Name',
	'separate_items_with_commas' => 'Separate Settings with commas',
	'add_or_remove_items' => 'Add or Remove Settings',
	'choose_from_most_used' => 'Choose from the most used Settings',
	'menu_name' => 'Marina Settings',
)));

function remove_marina_settings_metabox() {
	remove_meta_box('cnet_marina_settingsdiv','cnet_marinas','side');
}
add_action( 'admin_menu' , 'remove_marina_settings_metabox' );
...
add_action('init', 'marina_remove_editor'); 
function marina_remove_editor() { 
	remove_post_type_support( 'cnet_marinas', 'editor' );
}

function cleanup_marinas() {
	remove_meta_box( 'postexcerpt', 'cnet_marinas', 'normal' );
	remove_meta_box( 'trackbacksdiv', 'cnet_marinas', 'normal' );
	remove_meta_box( 'postcustom', 'cnet_marinas', 'normal' ); 
	remove_meta_box( 'authordiv', 'cnet_marinas', 'normal' ); 
}
add_action( 'admin_menu' , 'cleanup_marinas' );
