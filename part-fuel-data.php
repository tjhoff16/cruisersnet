        	...
        	<div class="marina-info">
        		...
        		<div class="fuel-table">
        			...
        			<?php
                        $gas=get_post_meta($post->ID,'gas_price',true);
                        $diesel = get_post_meta($post->ID,'diesel_price',true);
                        $gaspos   = strpos(strtoupper($gas),    'CALL');
                        $dieelpos = strpos(strtoupper($diesel), 'CALL');
                        if (get_post_meta($post->ID,'marina_reporting_date',true) && ! ($gaspos>=0 || $dieselpos>=0)) : ?>
        				<tr>
        				...
        				<tr>
        					<td><strong>Gasoline Price:</strong></td>
        					<td>
        						We were not able to get fuel prices for this Marina, call the number above for pricing.
        					</td>
        				</tr>
        				<?php } ?>
                        ...
                        <tr>
                            <td><strong>Any Other Discount:</strong></td>
