								...
								if (get_post_meta($post->ID,'cvcf-latitude_dec',true) && get_post_meta($post->ID,'cvcf-longitude_dec',true)) :
									...
									<div class="marina-featured marina-featured-post">
										<div class="marina-chartlet" style="width: <?php echo $wrapper_width; ?>px;">
											<iframe class="chartlet-iframe" id="chartlet-iframe-<?php echo $post->ID; ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="" data-src="<?php bloginfo('template_directory'); ?>/includes/features/chartlet-2018.php?ll=<?php echo get_post_meta($post->ID,'cvcf-latitude_dec',true); ?>,<?php echo get_post_meta($post->ID,'cvcf-longitude_dec',true); ?>&z=<?php echo get_post_meta($post->ID,'cvcf-chartletzoomlevel',true); ?><?php if (get_post_meta($post->ID,'marina_highlight',true) == 'yes') { echo '&highlight=1'; } ?><?php if (get_post_meta($post->ID,'chartlet_style',true) == 'hybrid') { echo '&amp;map=hybrid'; } ; ?>&amp;output=embed&amp;post=<?php echo $post->ID; ?>"></iframe><br />
