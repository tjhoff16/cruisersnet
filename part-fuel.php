	<?php
	if ($_GET['sort'] == 'diesel' && get_post_meta($post->ID,'diesel_price',true) == '') {
		
	} elseif ($_GET['sort'] == 'gas' && get_post_meta($post->ID,'gas_price',true) == '') {
		
	} elseif ($_GET['sort'] == 'vtechd' && get_post_meta($post->ID,'diesel_price',true) == '') {
		
	} elseif ($_GET['sort'] == 'vtechg' && get_post_meta($post->ID,'gas_price',true) == '') {
		
	} elseif ($_GET['sort'] == 'boatusd' && get_post_meta($post->ID,'diesel',true) == '') {
		
	} elseif ($_GET['sort'] == 'boatusd' && get_post_meta($post->ID,'gas_price',true) == '') {
		
	} elseif (get_post_meta($post->ID,'gas_price',true) != '' || get_post_meta($post->ID,'diesel_price',true) != '') {
	?>
